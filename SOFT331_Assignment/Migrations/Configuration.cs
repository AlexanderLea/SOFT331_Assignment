...
using System.Linq;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SOFT331_Assignment.Models.DatabaseContext>
    {
         ...
         protected override void Seed(SOFT331_Assignment.Models.DatabaseContext context)
        {
            ...
            {
                new Traveller { TravellerID=1, FirstName="No Gift Aid", LastName="No Gift Aid", Address1="No Gift Aid", PostCode="No Gift Aid" }
            };
            travellers.ForEach(t => context.Travellers.AddOrUpdate(t));
        }
    }    
}
